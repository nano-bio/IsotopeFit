...
dataaxes = axes('Parent',Parent,...
             ...
             'Units','normalized',...
             'Position',gridpos(18,8,10,17,1,6,0.05,0.02)); 
...
uicontrol(Parent,'Style','Text',...
    ...
    'Units','normalized',...
    'Position',gridpos(18,24,5,5,19,22,0.01,0.01));
...
e_resolution=uicontrol(Parent,'Style','edit',...
    ...
    'String','0',...
    'Background','white',...
    'Position',gridpos(18,24,5,5,23,24,0.01,0.01));

uicontrol(Parent,'Style','Text',...
    'String','Delta Mass (amu)',...
    'Units','normalized',...
    'Position',gridpos(18,24,4,4,19,22,0.01,0.01));
...
e_massoffset=uicontrol(Parent,'Style','edit',...
    ...
    'Background','white',...
    'Enable','on',...
    'Position',gridpos(18,24,4,4,23,24,0.01,0.01));
...
filenamedisplay = uicontrol(Parent,'Style','Text',...
    ...
    'Position',gridpos(18,8,18,18,2,6,0.01,0.01));
