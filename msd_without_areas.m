function out = msd_without_areas(spec_measured,massaxis,molecules,parameters)
...
[parameters,~] = get_fit_params_using_linear_system(spec_measured,massaxis,molecules,paramin,0,0);
